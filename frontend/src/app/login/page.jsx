...
export default function Login() {
    ...
    return (
        <main className="min-h-[calc(100dvh-4rem)] w-full flex items-center justify-center px-4 py-8 sm:py-10 overflow-hidden">
            <div className="relative w-full max-w-sm sm:max-w-lg md:max-w-xl">
                <div className="absolute inset-0 bg-gradient-to-tr from-indigo-500 via-sky-400 to-purple-500 rounded-3xl blur opacity-30 animate-pulse [animation-duration:6s]" aria-hidden="true" />

                <div className="relative rounded-3xl border border-white/40 bg-white/70 dark:bg-white/10 backdrop-blur-xl px-6 sm:px-8 md:px-14 py-8 sm:py-12 shadow-[0_8px_40px_-8px_rgba(0,0,0,0.25)] ring-1 ring-black/5 overflow-visible">
                    ...
                    <div className="pointer-events-none absolute -top-8 -right-8 h-24 w-24 rounded-full bg-gradient-to-tr from-indigo-400/20 via-sky-300/10 to-purple-400/20 blur-2xl -z-10" aria-hidden="true" />
                    <div className="pointer-events-none absolute -bottom-10 -left-10 h-28 w-28 rounded-full bg-gradient-to-tr from-purple-400/20 via-sky-300/10 to-indigo-400/20 blur-2xl -z-10" aria-hidden="true" />
                </div>
            </div>
        </main>
    );
