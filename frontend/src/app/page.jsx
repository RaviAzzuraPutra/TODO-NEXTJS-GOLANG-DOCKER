...
export default function Home() {
  return (
    <div className="flex-1 min-h-screen w-full flex items-center justify-center p-4">
      <div className="border border-white/40 bg-white/70 backdrop-blur-xl rounded-4xl py-10 px-6 sm:px-8 md:px-12 lg:px-16 flex flex-col items-center w-full max-w-lg md:max-w-xl lg:max-w-2xl shadow-[0_8px_30px_rgba(0,0,0,0.12)] ring-1 ring-black/5">
        <div className="mb-6">
          <div className="p-[3px] rounded-full bg-gradient-to-tr from-indigo-500 via-sky-400 to-purple-500 shadow-lg">
            <div className="rounded-full bg-white w-32 h-32 flex items-center justify-center overflow-hidden">
              <Image
                src="/assets/LOGO.png"
                alt="App Logo"
                width={128}
      ...
      <div className="pointer-events-none absolute inset-0 [background:radial-gradient(circle_at_20%_20%,rgba(99,102,241,0.18),transparent_60%),radial-gradient(circle_at_80%_40%,rgba(14,165,233,0.18),transparent_60%),radial-gradient(circle_at_50%_80%,rgba(168,85,247,0.18),transparent_60%)]" />
    </div>
  );
}
